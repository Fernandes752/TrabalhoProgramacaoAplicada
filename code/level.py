...
from code.Const import WIN_HEIGHT, C_WHITE, MENU_OPTION, EVENT_ENEMY, SPAWN_TIME, C_ORANGE, C_PINK, EVENT_TIMEOUT, \
...
class Level:
    def __init__(self, window, name, game_mode, player_score: list[int]):
        ...
        pygame.time.set_timer(EVENT_TIMEOUT, TIMEOUT_STEP)  # 100 milisegundos
